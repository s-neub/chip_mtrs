"""OOTB ModelOp Center model to compute and compare Pandas summaries on output data"""
...
def metrics(df_baseline: pandas.DataFrame, df_sample: pandas.DataFrame) -> dict:
    """A function to compare model output between baseline and sample (prod) datasets.
    ...
    Returns:
        dict: A comparison of pandas summaries of model output
    """
    ...
    yield concept_drift_detector.calculate_concept_drift(pre_defined_test="Summary")
