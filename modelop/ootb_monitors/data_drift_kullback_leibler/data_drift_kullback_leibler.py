"""OOTB ModelOp Center model to compute Kullback-Leibler divergences on input data"""
...
def metrics(
    ...
    """A function to compute Kullback-Leibler divergences given baseline and sample (prod) datasets.
    ...
    Returns:
        dict: Data drift metrics (KL divergence(s))
    """
