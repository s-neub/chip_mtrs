"""OOTB ModelOp Center model to compute Epps-Singleton p-values on input data"""
...
def metrics(df_baseline: pandas.DataFrame, df_sample: pandas.DataFrame) -> dict:
    """A function to compute Epps-Singleton p-values given baseline and sample (prod) datasets.
    ...
    Returns:
        dict: Data drift metrics (ES p-value(s))
    """
