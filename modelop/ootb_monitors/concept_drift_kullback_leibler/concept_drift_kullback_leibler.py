"""OOTB ModelOp Center model to compute the Kullback-Leibler divergence on output data"""
...
def metrics(df_baseline: pandas.DataFrame, df_sample: pandas.DataFrame) -> dict:
    """A function to compute Kullback-Leibler divergence given baseline and sample (prod) datasets.
    ...
    Returns:
        dict: Concept drift metric (KL Divergence)
    """
