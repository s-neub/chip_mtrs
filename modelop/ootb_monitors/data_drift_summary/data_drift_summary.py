"""OOTB ModelOp Center model to compute and compare Pandas summaries on input data"""
...
def metrics(df_baseline: pandas.DataFrame, df_sample: pandas.DataFrame) -> dict:
    """A function to compare model inputs between baseline and sample (prod) datasets.
    ...
    Returns:
        dict: A comparison of pandas summaries for each input column
    """
    ...
    yield drift_detector.calculate_drift(pre_defined_test="Summary")
