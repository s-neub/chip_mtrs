"""OOTB ModelOp Center model to compute the Kolmogorov-Smirnov p-value on output data"""
...
def metrics(df_baseline: pandas.DataFrame, df_sample: pandas.DataFrame) -> dict:
    """A function to compute Kolmogorov-Smirnov p-value given baseline and sample (prod) datasets.
    ...
    Returns:
        dict: Concept drift metric (KS p-value)
    """
